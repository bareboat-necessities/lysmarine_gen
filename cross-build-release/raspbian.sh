#!/bin/bash -xe
{
  ...
  thisArch="raspios"
  cpuArch="arm64"
  zipName="raspios_lite_arm64/images/raspios_lite_arm64-2026-06-19/2026-06-18-raspios-trixie-arm64-lite.img.xz"
  if [ "armhf" == "$MY_CPU_ARCH" ]; then
    cpuArch="armhf"
    zipName="raspios_lite_armhf/images/raspios_lite_armhf-2026-06-19/2026-06-18-raspios-trixie-armhf-lite.img.xz"
  fi
